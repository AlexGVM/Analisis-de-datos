...
--------------------------------------------------------------------------------------------
	...
	set statistics io on
		...
		from	Admisiones_DWH.Fact.Examen as e inner join
				...
				Admisiones_DWH.Dimension.Descuento as d on e.SK_Descuento = d.SK_Descuento inner join
				Admisiones_DWH.Dimension.Materia as m on e.SK_Materia = m.SK_Materia

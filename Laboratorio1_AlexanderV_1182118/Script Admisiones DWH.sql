...
--Metadata
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La tabla de hechos es una union proveniente de las tablas de Examen, Examen Detalle', 
     @level0type = N'SCHEMA', 
     @level0name = N'Fact', 
     @level1type = N'TABLE', 
     @level1name = N'Examen';
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La tabla de materia en la cual consistia el examen', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La tabla de descuento del examen', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
...
--Transformación en modelo lógico (mas detalles)
	...
	ALTER TABLE Dimension.Descuento ADD DescripcionDescuento [UDT_VarcharMediano]
...
--------------------------------------------------------------------------------------------
	...
	([ID_Materia],NombreMateria)
	select M.ID_Materia, M.NombreMateria
	...
	([ID_Descuento],DescripcionDescuento,PorcentajeDescuento)
	select D.ID_Descuento, D.Descripcion,D.PorcentajeDescuento
	...
	FROM Admisiones.DBO.Examen R
		...
		INNER JOIN Dimension.Descuento DD ON(DD.ID_Descuento = D.ID_Descuento)
		INNER JOIN Dimension.Materia DM ON(DM.ID_Materia = RR.ID_Materia)
